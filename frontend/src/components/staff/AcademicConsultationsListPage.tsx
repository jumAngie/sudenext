    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {academicConsultations.filter(c => c.status === 'pendiente').length}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {academicConsultations.filter(c => c.status === 'completada').length}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {academicConsultations.filter(c => c.followUpRequired).length}
            </div>
            <p className="text-xs text-muted-foreground">Necesitan atención adicional</p>
          </CardContent>
        </Card>
      </div>
